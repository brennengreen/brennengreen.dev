...
const products = [
    {'name':"Physically Based Raytracer", 'desc':"From scratch physically based raytracer", 'date':"--",'tool':"OpenGL, C++",link:"https://github.com/brennengreen/Raytracer" },
    ...
    {'name':"My Portfolio", 'desc':"A website to show off my personality and technical interests",'date':"--", 'tool':"WebDev w/ JS",'link':"https://github.com/brennengreen/brennengreen.dev"},
